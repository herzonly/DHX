...
function initializeHelper(bot) {
  ...
  bot.sendMessage = async function(chatId, textOrOptions, options = {}) {
    try {
      ...
      if (typeof textOrOptions === 'object' && !Buffer.isBuffer(textOrOptions)) {
        ...
        const parseMode = msg.parse_mode !== undefined ? msg.parse_mode : (options.parse_mode !== undefined ? options.parse_mode : null);
      ...
      const parseMode = options.parse_mode !== undefined ? options.parse_mode : null;
  ...
  bot.sendButton = async function(chatId, options = {}) {
    try {
      ...
      const parseMode = parse_mode !== undefined ? parse_mode : null;
  ...
  bot.sendValue = async function(chatId, questions = []) {
    try {
      ...
      for (let i = 0; i < questions.length; i++) {
        ...
        const parseMode = question.parse_mode !== undefined ? question.parse_mode : null;
        
        await bot.telegram.sendMessage(chatId, questionText, {
          parse_mode: parseMode,
          ...question.options
        });
        ...
        if (question.response) {
          ...
          const responseParseMode = question.parse_mode !== undefined ? question.parse_mode : null;
  ...
  bot.sendList = async function(chatId, text, title, rows = [], options = {}) {
    ...
    return await this.telegram.sendMessage(chatId, fullText, {
      ...keyboard,
      parse_mode: parseMode,
      ...options
    });
  ...
  bot.editMessageText = async function(text, options = {}) {
    try {
      ...
      const parseModeFinal = parse_mode !== undefined ? parse_mode : null;
...
async function smsg(bot, ctx) {
  ...
  m.replyToQuoted = async function(text, options = {}) {
    ...
    if (m.quoted) {
      return await ctx.telegram.sendMessage(m.chat, text, {
